                ...
                <tr>
                    ...
                    <td>
                        <div>
                              ...
                              <a href="<?php echo base_url(). 'staff/edit_nilai/' . $n->id_alternatif; ?> ">
                                <button class="btn btn-info btn-sm" name="input"><i class="glyphicon glyphicon-pencil"></i></button>
                            </a>
                           
                            <a href="<?php echo base_url() . 'staff/hapus_nilai/' . $n->id_alternatif; ?> ">
