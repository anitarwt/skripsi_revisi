        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-user"></i> <span>Halaman Staff</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="<?php echo base_url(); ?>staff/index"><i class="fa fa-home"></i>Home</a>
                            </li>
                            
                            <li><a><i class="fa fa-sitemap"></i> Data Kriteria<span
                                            class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo base_url(); ?>staff/tambah_kriteria">Tambah Kriteria</a></li>
                                    <li><a href="<?php echo base_url(); ?>staff/tampil_kriteria">Tampil Kriteria</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-desktop"></i>Alternatif<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo base_url(); ?>staff/tampil_pegawai">Tampil Alternatif</a></li>
                                    <li><a href="<?php echo base_url();?>staff/tambah_pegawai">Tambah Alternatif</a></li>
                            ...
                            <a><i class="fa fa-paste"></i>Nilai<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo base_url(); ?>staff/tampil_nilai">Tampil Nilai</a></li>
                                    <li><a href="<?php echo base_url();?>staff/tambah_nilai">Tambah Nilai</a></li>

                                </ul>
                          </li>

                            <li><a href="<?php echo base_url(); ?>staff/tampil_rangking"><i class="fa fa-file"></i>Laporan</a>
                            </li>
                        </ul>
                    </div>
                    <div class="menu_section">
            ...
            <div class="nav_menu">
                <nav>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo base_url()?>staff/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                    </ul>
                    </li>
